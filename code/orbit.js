...
function atribute_span_values(){
    ...
    document.querySelector("#property_title_lenght").innerText = `Telescope ${((parseFloat(radius_lenght)-0.05)/1.95*99+1).toFixed(0)}`
    document.querySelector("#property_title_animation_velocity").innerText = `Time ${(parseFloat(animation_velocity)*99+1).toFixed(0)}`
    document.querySelector("#property_title_point_size").innerText = `Meteor ${((parseFloat(point_size-0.05)/1.45)*9+1).toFixed(0)}`
    document.querySelector("#property_title_point_number").innerText = `Orbits ${parseFloat(point_number*1000).toFixed(0)}`
    document.querySelector("#property_title_trace").innerText = `Tail ${(parseFloat(trace)*99+1).toFixed(0)}`
...
function change_clear(){
    ...
    if(clear_active){
        ...
        clear_button.innerHTML = "Clear | OFF"
        ...
        clear_button.innerHTML = "Clear | ON&nbsp;"
